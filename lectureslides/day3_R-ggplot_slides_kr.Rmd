---
title: 'Intro to R: Day 3, part 3'
subtitle: 'Data viz with ggplot'
...
1. If you still have `imports`, `generation`, `merged_energy`, `long_gen` and `long_merged_energy` in your Enrivorment, run the code from your Day 1 exercises file to get `gapminder5` and `gapminder07`.
2. If you are missing any of those objects from your workspace, run the following line of code:

```{r, warning=FALSE, message=FALSE}
library(here)
source(here("data/day3_objects.R"))
```
...
## Exercise: Hydro power generated over time
...
>    - `geom_smooth()` plots smoothed conditional means (estimated using a loess regression)
...
## Example: Columns, position stack

## Example: Columns, position dodge
