...
1. If you still have `imports`, `generation`, `merged_energy`, `long_gen` and `long_merged_energy` in your Enrivorment, run the code from your Day 1 exercises file to get `gapminder` and `gapminder07`.
