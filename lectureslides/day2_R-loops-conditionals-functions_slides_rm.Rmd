...
## Another word of caution -- used vectorized functions when possible

- Everything in R is a vector!
- It is quicker and easier to use vectorized functions when possible
  - The function is applied to each item in the vector
...
1) Save your Rmarkdown file: "lastname_firstname_r_bootcamp_day2"
