...
The R session materials are stored in the following read-only directory: "~/team/bootcamp/2018/R". Copy the "data" and "exercises" subfolders (and others if you want) to a directory in your home folder.
