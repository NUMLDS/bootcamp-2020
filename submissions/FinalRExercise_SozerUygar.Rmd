...
```{r}
# merged_schools06[ ,.(reading_score = mean(z_ela_score, na.rm=T), math_score = mean(z_math_score, na.rm = T), acs[county_name == county_name, poverty_level, by=county_name]), by=.(county_name)]
```
